...
from src.models.lstm_encoder_decoder_model import seq2seq_model_builder
...
for i, sentence in enumerate(sentences):
    for t, char in enumerate(sentence):
        ...
        #print("i: {}, t:{}, char_indices: {}".format(i, t, char_indices[char]))
...
"""
model = seq2seq_model_builder(vocab_size=len(chars))
model.summary()
#model = Sequential(
#    [
...
for epoch in range(epochs):
    model.fit([x, x], y, batch_size=batch_size, epochs=1)
    print()
